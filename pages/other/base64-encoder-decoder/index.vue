<template>
    <UiCalcPage title="Base64 Encoder / Decoder" category="other" description-title="Encode and decode Base64 — UTF-8 safe, in your browser">
        <template #calc>
            <CalculatorsOtherBase64Calc />
        </template>
        <template #facts>
