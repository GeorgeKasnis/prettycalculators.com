<template>
    <UiCalcPage title="Color Contrast Checker" category="tools" description-title="Test text and background colors against WCAG">
        <template #calc>
            <CalculatorsToolsColorContrastCalc />
        </template>
        <template #facts>
        ...
        <template #description>
            ...
            <p>
                Working on a design system? Pair this with our <NuxtLink to="/tools/css-clamp-calculator">CSS clamp() calculator</NuxtLink> for fluid type and the <NuxtLink to="/tools/px-to-rem-calculator">px to rem converter</NuxtLink> for accessible sizing.
            </p>
        </template>
        <template #example>
            <p>
