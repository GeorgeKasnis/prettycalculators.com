<template>
    <UiCalcPage title="Password Generator" category="tools" description-title="Strong random passwords — generated on your device">
        <template #calc>
            <CalculatorsToolsPasswordGeneratorCalc />
        </template>
        <template #facts>
