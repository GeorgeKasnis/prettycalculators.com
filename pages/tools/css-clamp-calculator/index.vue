<template>
    <UiCalcPage title="CSS clamp() Calculator" category="tools" description-title="Generate fluid typography that scales with the viewport">
        <template #calc>
            <CalculatorsToolsCssClampCalc />
        </template>
        <template #facts>
        ...
        <template #description>
            ...
            <p>
                We output the fixed part in rem (not px) so text still scales when users change their browser's default font size — important for accessibility and often flagged in audits. Converting other px values to rem? Use our <NuxtLink to="/tools/px-to-rem-calculator">px to rem calculator</NuxtLink>.
            </p>
        </template>
        <template #example>
            <p>
