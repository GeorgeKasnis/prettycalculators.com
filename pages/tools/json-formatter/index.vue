<template>
    <UiCalcPage title="JSON Formatter & Validator" category="tools" description-title="Format, validate and minify JSON — privately, in your browser">
        <template #calc>
            <CalculatorsToolsJsonFormatterCalc />
        </template>
        <template #facts>
