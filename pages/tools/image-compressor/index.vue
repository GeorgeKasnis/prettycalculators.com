<template>
    <UiCalcPage title="Image Compressor" category="tools" description-title="Compress images to a target size — right in your browser">
        <template #calc>
            <CalculatorsToolsImageCompressorCalc />
        </template>
        <template #facts>
