...
const faqs = [
    ...
    { q: "How much house can I afford?", a: "The common guideline is the 28/36 rule: your monthly housing cost (P&I + taxes + insurance + PMI) should not exceed 28% of gross monthly income, and total debt payments (including car, student loans, etc.) should not exceed 36%. At $80,000/year gross ($6,667/month), your maximum housing payment is ~$1,867/month. Use this calculator in reverse: start with a target payment and work backward to a home price." },
