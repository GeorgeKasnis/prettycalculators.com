export default defineEventHandler(async (event) => {
    ...
    const staticUrls = [
        ...
        { loc: '/other/image-compressor',               changefreq: 'monthly', priority: '0.85' },
        { loc: '/other/qr-code-generator',              changefreq: 'monthly', priority: '0.85' },
        { loc: '/other/json-formatter',                 changefreq: 'monthly', priority: '0.85' },
        { loc: '/other/unix-timestamp-converter',       changefreq: 'monthly', priority: '0.85' },
        { loc: '/other/aspect-ratio-calculator',        changefreq: 'monthly', priority: '0.85' },
        { loc: '/other/css-clamp-calculator',           changefreq: 'monthly', priority: '0.85' },
        { loc: '/other/password-generator',             changefreq: 'monthly', priority: '0.85' },
        { loc: '/other/diff-checker',                   changefreq: 'monthly', priority: '0.85' },
        { loc: '/other/color-contrast-checker',         changefreq: 'monthly', priority: '0.85' },
        { loc: '/other/base64-encoder-decoder',         changefreq: 'monthly', priority: '0.85' },
        { loc: '/other/uuid-generator',                 changefreq: 'monthly', priority: '0.85' },
