const CATEGORIES = {
    ...
    other: {
        ...
        tools: [
            ...
            { label: "Password Generator", to: "/other/password-generator" },
            { label: "JSON Formatter", to: "/other/json-formatter" },
            { label: "Diff Checker", to: "/other/diff-checker" },
            ...
            { label: "Color Contrast Checker", to: "/other/color-contrast-checker" },
            { label: "Base64 Encoder / Decoder", to: "/other/base64-encoder-decoder" },
            { label: "UUID Generator", to: "/other/uuid-generator" },
