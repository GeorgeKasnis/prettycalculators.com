const CATEGORIES = {
    ...
    other: {
        ...
        tools: [
            { label: "Image Compressor", to: "/other/image-compressor" },
            { label: "QR Code Generator", to: "/other/qr-code-generator" },
            { label: "JSON Formatter", to: "/other/json-formatter" },
            { label: "Age Calculator", to: "/other/age-calculator" },
            { label: "Px to Rem Calculator", to: "/other/px-to-rem-calculator" },
            { label: "Unix Timestamp Converter", to: "/other/unix-timestamp-converter" },
            { label: "Aspect Ratio Calculator", to: "/other/aspect-ratio-calculator" },
            { label: "CSS clamp() Calculator", to: "/other/css-clamp-calculator" },
            ...
            { label: "Word Counter", to: "/other/word-counter" },
